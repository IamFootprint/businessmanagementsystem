...
import { listSuppliers, getSupplier, createSupplier, addSupplierAlias, removeAlias } from '../controllers/supplier.controller'
...
export function registerSupplierRoutes(app: Hono<AppEnv>) {
  ...
  app.delete('/suppliers/:id/aliases/:aliasId', sessionMiddleware, requireRole(...writeRoles), removeAlias)
}
